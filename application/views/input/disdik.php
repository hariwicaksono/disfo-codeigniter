	...
	<div class="row">
		<div class="col-sm-12" >
			<div class="alert alert-info">
				...
				Bagian ini hanya untuk Layout 3
			</div>
						...
						?>
							<tr>
								...
								<td>
									...
									<a href="<?=site_url('input/disdik/hapus/'. $agenda->id); ?>" class="text-red">
...
function load_new(){
	...
	$.post(_BASE_URL + 'input/disdik/load_new',function(f){
		$('#modalku').html(f);
		$('.content-wrapper').LoadingOverlay('hide');
		$('#modal-disdik').modal('show');
	},'html');
}
function load_edit(idagenda){
	$('.content-wrapper').LoadingOverlay('show');
	$.post(_BASE_URL + 'input/disdik/edit',{id:idagenda},function(f){
		$('#modalku').html(f);
		$('.content-wrapper').LoadingOverlay('hide');
		$('#modal-disdik').modal('show');
	},'html');
