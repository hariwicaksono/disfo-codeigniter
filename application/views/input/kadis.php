						...
						?>
							<tr>
								...
								<td>
									...
									<a href="<?=site_url('input/kadis/hapus/'. $agenda->id); ?>" class="text-red">
...
function load_new(){
	...
	$.post(_BASE_URL + 'input/kadis/load_new',function(f){
		$('#modalku').html(f);
		$('.content-wrapper').LoadingOverlay('hide');
		$('#modal-kadis').modal('show');
	},'html');
}
function load_edit(idagenda){
	$('.content-wrapper').LoadingOverlay('show');
	$.post(_BASE_URL + 'input/kadis/edit',{id:idagenda},function(f){
		$('#modalku').html(f);
		$('.content-wrapper').LoadingOverlay('hide');
		$('#modal-kadis').modal('show');
	},'html');
