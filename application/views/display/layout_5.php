...
<div class="wrapper" style="background:url('<?=base_url('images/'.$this->settings->info['background']);?>') no-repeat center center fixed;-webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover;">
	...
	<div class="row">
		<div class="col-sm-9">
			...
			<div class="row">
				<div class="col-sm-4">
					<div class="body bg-orange-no up-card">
						<span class="header-agenda-mengajar">JADWAL MENGAJAR HARI INI</span>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="card">
					<div class="body bg-green">
						<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
							<div class="carousel-inner" id="guru-mengajar">
						...
						<div class="item <?php echo ($noevent==1 ? "active" : ""); ?>">
							<div class="body bg-cyan" style="padding:2px 5px 2px 15px;">
								...
								<p>
									...
									<span><h3 style="line-height:0.6;" id="waktu-event"><?=$waktu_event; ?> - Selesai</h3></span>
								</p>
							</div>
						</div>						
					<?php	
...
function guru_mengajar(int_jam_ke){
	...
	$.post(_BASE_URL + 'display/slide_guru_mengajar',{jam_ke:int_jam_ke,hari:xhari},function(f){
		$('#guru-mengajar').html(f);
	},'html');		
}
</script>